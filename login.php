...
<div class="df f-c fjustify-evenly m-20 .fjustify-center card container2 bn">
    <section class="between-flex bc-light-gray p-20 rad-6 shadow-dark-gray fjustify-center add m-20">
        ...
        <div class="df f-c card bc-light-gray bn">
            <h2 class="c-g txt-c mb-20">التسجيل</h2>
            <form class="df f-c bc-light-gray n-shadow mt-n p-20 rad-n">
                <label for="username" class="c-purple txt-w mb-10">اسم المستخدم:</label>  
                <input type="text" id="name" name="name" class="bc-white c-black mb-10 p-20 rad-6" placeholder="ادخل اسم المستخدم" required>
                ...
                <input type="password" id="password" name="password" class="bc-white c-black mb-10 p-20 rad-6" placeholder="ادخل كلمة السر" required>
                 ...
                 <input type="text" name="code" id="code" placeholder="ادخل رمز التحقق المرسل الى بريدك الالكتروني" class="bc-light-gray c-black mb-10 p-20 code" required maxlength="5" minlength="5">
                <button onclick="login()" class="bc-purple c-white sid-icon p-20 rad-6 " id="display_code_side">تسجيل الدخول</button>
